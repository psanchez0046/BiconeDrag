...
This experiment file has been generated using a viscoelastic interface \eta_s^* = \eta_s' - i\eta_s'' with modulus |\eta_s^*| varying from 1e-6 to 1 in 10 logarithmically spaced steps.
